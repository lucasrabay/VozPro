...
- [Biu — Assistente de Emprego via WhatsApp](#biu--assistente-de-emprego-via-whatsapp)
  - [Sumário](#sumário)
  - [Como funciona](#como-funciona)
  - [Arquitetura](#arquitetura)
  - [Requisitos](#requisitos)
  - [Como rodar (passo a passo)](#como-rodar-passo-a-passo)
    - [1. Clone e configure as variáveis de ambiente](#1-clone-e-configure-as-variáveis-de-ambiente)
    - [2. Suba os containers](#2-suba-os-containers)
    - [3. Escaneie o QR code](#3-escaneie-o-qr-code)
    - [4. Pronto](#4-pronto)
    - [5. Parar os containers](#5-parar-os-containers)
  - [Testar a conversa](#testar-a-conversa)
  - [Logs e troubleshooting](#logs-e-troubleshooting)
    - [Problemas comuns](#problemas-comuns)
  - [Desenvolvimento local](#desenvolvimento-local)
    - [Brain (Python)](#brain-python)
    - [Gateway (Node.js)](#gateway-nodejs)
    - [Editar o prompt do Biu em tempo real](#editar-o-prompt-do-biu-em-tempo-real)
